...
function App() {
  ...
  const { renderAgreementTypeDropDown, agreementType } = useSelectAgreementComponent();
            ...
            return (
              <div>
                <button
                  ...
                  onClick={() =>updateStep(currentStep - 1 === 0 ? currentStep : currentStep - 1)}>Föregående steg
                </button>
                <button
                  className="primaryButton"
                  onClick={() =>
