  ...
  return (
    <div className="App">
      ...
      {currentStep + 1 === 0 || currentStep + 1 === 1 || currentStep + 1 === 2 || currentStep + 1 === 3 || currentStep + 1 === 4 ? (
        <button className="primaryButton" onClick={() => updateStep(currentStep + 1 === 5 ? currentStep : currentStep + 1)}>Nästa steg</button>)
        :
        (
          <button className="primaryButton" onClick={() => PreviewAgreementComponent()}>Generera Avtal</button> )}
